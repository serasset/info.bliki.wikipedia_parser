...
/**
 * Reads <code>User</code> data from an XML file generated by the <a href="https://meta.wikimedia.org/w/api.php">Wikimedia API</a>
 */
public class XMLUserParser extends AbstractXMLParser {
    ...
    public XMLUserParser(User user, String xmlText) throws SAXException, ParserConfigurationException {
        super(xmlText);
        fUser = user;
    }
